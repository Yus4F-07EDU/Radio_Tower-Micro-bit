...
I’ve made a radio system for the Micro:bit and after testing it out, it actually works! You can download it and try it yourself or use it with your friends. Just keep in mind that you have to configure it yourself, like choosing what messages you want to send between the Micro:bits. Anything you change after downloading it is your own responsibility.
